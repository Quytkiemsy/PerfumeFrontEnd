...
const AdminUsersPage = async () => {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-red-100">
                <div className="text-center p-8 bg-white rounded-2xl shadow-xl max-w-md">
                    ...
                    <a 
                        href="/" 
                        className="inline-block px-6 py-3 bg-gradient-to-r from-gray-800 to-gray-900 text-white rounded-lg font-semibold hover:from-gray-900 hover:to-black transition-all"
                    >
                        Trở về trang chủ
                    </a>
                </div>
    ...
    const res = await sendRequest<IBackendRes<IModelPaginate<IUser>>>({
        url: `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v1/admin/users`,
        method: 'GET',
        headers: {
